import { SortUtil } from "./src/app";
import { NumberGroup } from "./src/model/numberGroup";
import { CharacterGroup } from "./src/model/characterGroup";
import { LinkedListGroup } from "./src/model/LinkedListGroup";
